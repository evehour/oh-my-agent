...
| brainstorm | Идеация, исследование концепций | Проектный документ |
| db-agent | База данных, схема, ERD, миграция | Проектирование схем, оптимизация запросов |
| dev-workflow | CI/CD, git hooks, настройка монорепо | Конфигурации рабочих процессов, автоматизация |
| tf-infra-agent | Terraform, облачная инфраструктура | Модули IaC, управление состоянием |
| translator | Перевод, многоязычный контент | Переведённый текст с сохранением тона |
