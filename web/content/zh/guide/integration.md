...
`installWorkflows()` 将所有工作流文件复制到 `.agents/workflows/`。这些是 `/orchestrate`、`/work`、`/ultrawork`、`/plan`、`/exec-plan`、`/brainstorm`、`/deepinit`、`/review`、`/debug`、`/design`、`/commit`、`/tools` 和 `/stack-set` 的定义。
