...
### 渐进式披露
IDE 自动将请求匹配到技能。您无需手动选择技能。只有所需的技能会加载到上下文中。
...
| brainstorm | 构思、概念探索 | 设计文档 |
| db-agent | 数据库、模式、ERD、迁移 | 模式设计、查询调优 |
| dev-workflow | CI/CD、git hooks、monorepo 配置 | 工作流配置、自动化 |
| tf-infra-agent | Terraform、云基础设施 | IaC 模块、状态管理 |
| translator | 翻译、多语言内容 | 保留语气的翻译文本 |
